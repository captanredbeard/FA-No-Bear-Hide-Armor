...
namespace CakeBuild
{
    ...
    {
        public const string ProjectName = "fabeararmorhide";
    ...
    public sealed class PackageTask : FrostingTask<BuildContext>
    {
        public override void Run(BuildContext context)
        {
            ...
            context.Zip($"../Releases/{context.Name}", $"../Releases/Forgotten Armory_Bear_Hide_Armor_Removal_Recipes_Only_{context.Version}.zip");
        }
    }
